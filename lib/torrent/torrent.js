...
Torrent.prototype.stop = function () {
    if (this.status === Torrent.READY) {
        ...
        var torrent = this;
            torrent._setStatus(Torrent.STOPPED);
    }
};
...
Torrent.prototype._initialise = function () {
    ...
    if (!this._extensionMap) {
        ...
        for (var i = 0; i < this._extensions.length; i++) {
            ...
            if (typeof this._extensions[i] === 'function') {
                this._extensions[i] = new ExtensionClass(this);
            }
...
Torrent.STOPPED = 'torrent:stopped';
